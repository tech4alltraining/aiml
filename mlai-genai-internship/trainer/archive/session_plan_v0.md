...
* **Demo: The JSON Treasure Hunt** Use an API client like Postman or a very basic Python script to call an LLM API. Show the raw JSON response so they understand that the output is just data structured in a specific way.
