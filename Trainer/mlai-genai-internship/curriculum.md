...
| Also see | For |
|---|---|
| [**Student Handbook**](../student-handbook.md) | Students — concepts, analogies, runnable code, all 38 activities |
...
| [**Prompt Library**](../prompts.md) | Every demo prompt, ready to copy |
| [**Notebooks**](../notebooks) | Six Colab/Jupyter notebooks, outputs included |
| [**Streamlit Apps**](../tutorials/apps/streamlit-apps-collection.md) | 15 runnable apps, simple to advanced |
| [**Exercises**](../exercises-assignments.md) | Practice per concept, plus graded assignments |
| [**Setup Guide**](../setup-guide.md) | Windows, Ubuntu, macOS · venv or conda |
| [**Index**](../README.md) | Everything in this folder |

> **All code in this programme runs in an environment named `genai`.** Setup for Windows, Ubuntu and macOS: [Setup Guide](../setup-guide.md).
...
- [Notebook 00a](../notebooks/00a_python_foundations.ipynb)
##### Python Foundations Part B: collections, conditions, loops, functions
- [Notebook 00b](../notebooks/00b_python_foundations_2.ipynb)
##### Scenario Worksheets: ten real-world problems
- [Notebook 00c](../notebooks/00c_python_scenarios.ipynb)
- Scenario 10 (ML Data Prep) is the direct bridge into Day 1
##### Additional drills
...
##### Prompt Engineering Basics
  ...
  * [Demo 4.1b] - Without Prompt Engineering (smartphone) — see [prompts.md §2](../prompts.md#2-weak-vs-strong-prompts)
...
##### Hands-on GenAI Activities
  ...
  * [Apps: Text Generator, Chatbot](../tutorials/apps/streamlit-app-simple.md)
  * [Apps: YouTube Summarizer, Diagnostic Helper](../tutorials/apps/streamlit-app-advanced.md)
...
##### Recap: Types of Prompts (from Day 4)
...
- [Tutorial: Open-Source GenAI Models](../tutorials/concepts/open-source-gen-ai.md)
##### Hugging Face Ecosystem
- [Tutorial: Hugging Face Ecosystem](../tutorials/concepts/hugging-face-ecosystem.md)
- *Handbook Activity 5.1 — Two models, one sentence · Activity 5.2 — Read a model card*
##### AI-powered Application Concepts
- [Tutorial: AI-Powered Application Concepts](../tutorials/concepts/ai-powered-apps.md)


#### **Session 5.2: *Capstone Project & GenAI Application Development***
##### Streamlit App Development
- [Tutorial: Loan Approval App (ML model + Streamlit)](../tutorials/apps/loan-app.md) — *Handbook Activity 5.3*
- [Tutorial: ML + GenAI (prediction + explanation)](../tutorials/apps/ml_gen_ai.md) — *Handbook Activity 5.4*
##### Project Grouping & Topic Selection
##### Capstone Project Planning
- [Capstone guide, deliverables and marking](../student-handbook.md#capstone-project-guide)
